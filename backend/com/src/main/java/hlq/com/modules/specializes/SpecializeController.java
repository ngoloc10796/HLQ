...
public class SpecializeController extends BaseController {

	@Autowired
	private SpecializeService service;
	...
	@PostMapping(value = "")
	public ResponseEntity<ResponseBean> create(@RequestBody Specialize data) {
		ResponseBean response = new ResponseBean();
		try {
	...
	@PutMapping(value = "")
	public ResponseEntity<ResponseBean> update(@RequestBody Specialize data) {
		ResponseBean response = new ResponseBean();
		try {
