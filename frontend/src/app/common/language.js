...
App_Dictionary = [
  ...
  //client
  ['client_name', 'Họ và tên', ''],
  ['client_phone', 'Số điện thoại', ''],
  ['client_birthday', 'Ngày sinh', ''],
  ['client_email', 'email', ''],
  ['client_provinceId', 'Tỉnh/Thành phố', ''],
  ['client_districtId', 'Quận/Huyện', ''],
  ['client_communeId', 'Xã/Thôn', ''],
  ['client_peopleId', 'Số CMND', ''],
  ['client_permanentResidence', 'Hộ khẩu thường trú', ''],
  ['client_schools', 'Trường THCS/THPT', ''],
  ['client_youGraduated', 'Bạn đã tốt nghiệp', ''],
  ['client_graduationYear', 'Năm tốt nghiệp', ''],
  ['client_score', 'Điểm tổng kết học bạ', ''],
  ['client_wantToApply', 'Bạn muốn xét tuyển', ''],
  ['client_aspirations1', 'Nguyện vọng 1', ''],
  ['client_aspirations2', 'Nguyện vọng 2', ''],
  ['client_mailingAddress', 'Chúng tôi thông báo kết quả tuyển sinh cho bạn theo nguyện vọng nào? Địa chỉ nhận thư (Ghi rõ Thôn/Xóm - Xã/Phường - Quận/Huyện - Tỉnh/TP)', ''],
  ['client_phoneAnswered', 'Điện thoại', ''],
  ['client_linkFacebook', 'Link Facebook', ''],
