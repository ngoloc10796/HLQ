(function () {
  ...
  angular
    .module("MyApp")
    .controller("prioritize.Controller", function ($rootScope, $scope, $timeout, $q, $state, $stateParams, $compile, AuthService, ApiService, APP_CONFIG) {

      var a_language = APP_CONFIG.languageConfig.language;
      var a_userInfo = APP_CONFIG.userInfo;

      $scope.module = "prioritize";
      ...
      $scope.initTable = function () {
        $scope.config = {
          ...
          // },
          {
            title: a_language.prioritize_numericalOrder,
            data: "numericalOrder",
            width: "50px",
            className:"text-center"
          },
          {
            title: a_language.prioritize_name,
            data: "name",
            width: "200px",
          },
          {
            title: a_language.prioritize_description,
            data: "description",
            width: "auto",
          },
